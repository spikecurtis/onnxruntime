...
class GraphExecutionManagerFactory(object):
    def __init__(self, module, debug_options: DebugOptions, fallback_manager: _FallbackManager, export_modules_as_functions):
        self._training_manager = TrainingManager(module, debug_options, fallback_manager, export_modules_as_functions)
        self._inference_manager = InferenceManager(module, debug_options, fallback_manager, export_modules_as_functions)
